...
const dataArr: Veg[] = [
	...
	},
	{
		...
		soil: 'Agurkams parenkama nuo vyraujančių šaltų vėjų krūmais, medžiais, pastatais ir pan. apsaugota, gerai saulės apšviesta vieta. Skirtingai nuo kitų agurkinių šeimos atstovų agurkai yra labai reiklūs oro bei dirvos drėgmei. Jų lapų paviršius yra didelis ir išgarina daug vandens, o pagrindinė šaknų sistema yra dirvos paviršiuje, kurios paprastai greitai išdžiūsta. Agurkai gerai dera daug humuso turinčiose puriose dirvose. Be to, jie labai jautrūs dirvos rūgštumui (pH ne mažesnis kaip 6,5).',
